...
#### 报警效果图:
###### 微信:
![](https://github.com/guomaoqiu/prometheus_notes/master/screenshots/wechat_alert.png)
###### 邮件:
![](https://github.com/guomaoqiu/prometheus_nodes/master/screenshots/email_alert.png)
### 四、可视化
##### 0.安装grafana(docker)
```
...
###### 2. 数据可视化效果图:
![](https://github.com/guomaoqiu/prometheus_nodes/master/screenshots/monitor_dashboard.png)
