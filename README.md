...
#### 报警效果图:
###### 微信:
![](https://github.com/guomaoqiu/prometheus_notes/blob/master/screenshots/wechat_alert.png)
###### 邮件:
![](https://github.com/guomaoqiu/prometheus_nodes/blob/master/screenshots/email_alert.png)
### 四、可视化
##### 0.安装grafana(docker)
```
